...
public class FunctionLibrary 
{
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox")){
			...
			if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("Chrome")){
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\srikanth.ch\\workspace\\SrikanthMavenStockAccounting\\BrowserExcutableFile\\chromedriver.exe");
	...
	public static void captureData(WebDriver driver,String locatorType,String locatorValue) throws Throwable
	{
		...
		FileWriter fw=new FileWriter("C:\\Users\\srikanth.ch\\workspace\\SrikanthMavenStockAccounting\\CaptureData\\data.txt");
...
//SupplierCreation Table Validation
	...
	//Reading the Supplier Number  from  text file 
		...
		FileReader fr=new FileReader("C:\\Users\\srikanth.ch\\workspace\\SrikanthMavenStockAccounting\\CaptureData\\data.txt");
