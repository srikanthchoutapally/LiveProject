...
public class ExcelFileUtil
{
	...
	{
		FileInputStream fis=new FileInputStream("C:\\Users\\srikanth.ch\\workspace\\StockAccounting\\TestInputs\\InputSheet.xlsx");
	...
	public void setData(String sheetname,int row,int column,String status) throws Throwable
	{
		...
		FileOutputStream fos=new FileOutputStream("C:\\Users\\srikanth.ch\\workspace\\StockAccounting\\TestOutput\\OutputSheet.xlsx");
		wb.write(fos);
		fos.close();
	}
